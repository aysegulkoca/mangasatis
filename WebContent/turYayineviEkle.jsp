...
<head>
    ...
    <link rel="stylesheet" href="yt-ekle-style.css">
    ...
    <div class="wrapper">
        <div class="container">
            ...
            <div class="container">
                ...
                <hr>
                <div class="form-yt">
                    <legend>Yeni Tür Ekle</legend>
					<form action="TurYayineviEkle" method="POST">		
						<div class="form-group row">
							<label>Tür Adı : </label>
	                        <input name="tur" type="text" class="form-control" placeholder="Tür Adını Giriniz">
							<button type="submit" name="turButton" value="turButton" class="btn btn-outline-success">EKLE</button>
	                    </div>
	                    <hr>
	                    <legend>Yeni Yayınevi Ekle</legend>
	                    <div class="form-group row">
	                   		<label>Yayınevi Adı : </label>
	                        <input name="yayinevi" type="text" class="form-control" placeholder="Tür Adını Giriniz">
	                        <button type="submit" name="yayineviButton" value="yayineviButton" class="btn btn-outline-success">EKLE</button>
	                    </div>  
					</form>
				</div>
            </div>
